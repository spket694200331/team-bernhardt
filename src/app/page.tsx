...
const hubSections = [
  ...
  },
  {
    ...
    overlay: 'bg-navy-deep/70', objectPosition: 'object-[center_15%]',
  },
  {
    title: "Olga's Corner",
    href: '/olgas-corner',
    image: '/images/olga.jpeg',
    overlay: 'bg-olga-teal/70', objectPosition: 'object-[center_15%]',
  },
]
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div
          ...
          <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
            ...
            we&apos;re lost in a good book, spotting rare birds, or hitting the slopes and the
            open water on the Sunseeker — this is our home base.
          </p>
          <p className="text-luke-gold/90 text-sm font-semibold tracking-[0.3em] uppercase mt-6">
            Семья · Вера · Успех
          </p>
          <Link
            href="#gallery"
            className="inline-flex items-center gap-2 mt-10 px-8 py-4 bg-navy-mid hover:bg-navy-light
                       text-white font-semibold rounded-full transition-all duration-300
                       hover:shadow-lg hover:shadow-navy-deep/40 text-sm tracking-wide"
          >
        ...
        <motion.div
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 text-white/60 animate-bounce-slow"
        >
          <ChevronDown size={28} />
        </motion.div>
      </section>
            ...
            >
              ...
              >
                <div className="text-center text-white">
                  <p className="text-2xl font-bold drop-shadow-lg">{section.title}</p>
                  <p
                    className="flex items-center justify-center gap-1 mt-2 text-sm font-medium
      ...
      <section className=" py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <AnimatedSection
              delay={0.1}
              className="bg-cream-soft rounded-2xl p-8 border border-cream-gray"
            >
              <div className="w-12 h-12 bg-navy-mid/10 rounded-xl flex items-center justify-center mb-4">
                <span className="text-2xl">⚡</span>
              </div>
              <h3 className="text-xl font-bold text-navy-deep mb-3">Our Passions</h3>
              <p className="text-gray-600 leading-relaxed">
                Dive into high-energy soccer and karate action with bold Philadelphia Eagles vibes.
                From the track at Liberty University to the open water on the Sunseeker — we live
                life full throttle.
              </p>
            </AnimatedSection>
            <AnimatedSection
            ...
            >
              ...
              <h3 className="text-xl font-bold text-navy-deep mb-3">Family Life</h3>
              <p className="text-gray-600 leading-relaxed">
                From sports thrills to cozy corners, we celebrate what makes each of us unique —
                unified by love. Whether it&apos;s a book nook or a ski slope, we&apos;re always in
                it together.
              </p>
            </AnimatedSection>
          </div>
      ...
      <section className="bg-cream-soft py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold text-navy-deep">Our World</h2>
          </AnimatedSection>
          <div className="grid md:grid-cols-3 gap-8">
            {worldSections.map((section, i) => (
              <AnimatedSection key={section.href} delay={i * 0.1}>
                <Link href={section.href} className="block group">
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3 className="text-lg font-bold text-navy-deep mb-2">{section.title}</h3>
                      <p className="text-gray-500 text-sm leading-relaxed mb-4">{section.desc}</p>
                      <span
      ...
      <section className=" py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold text-navy-deep mb-4">Family Moments</h2>
            <p className="text-gray-500 text-lg">
              Snapshots capturing joy, adventure, and togetherness.
            </p>
          </AnimatedSection>
            ...
            {familyPhotos.map((photo, i) => (
              <AnimatedSection key={i} delay={i * 0.05}>
                <button
                  ...
                  className="relative h-48 md:h-64 w-full rounded-xl overflow-hidden shadow-sm
      ...
      <section className="relative py-32 px-6">
        <Image
          src="https://images.unsplash.com/photo-1556745753-b2904692b3cd?w=1600&q=80"
          ...
          <AnimatedSection className=" rounded-2xl shadow-2xl p-10 md:p-14 w-full max-w-xl">
            ...
            <form className="space-y-4">
              <input
                ...
                className="border border-gray-200 rounded-lg px-4 py-3 w-full text-sm
                           focus:ring-2 focus:ring-navy-mid focus:outline-none transition-all"
              />
              <input
                type="email"
              ...
              <textarea
                ...
                className="border border-gray-200 rounded-lg px-4 py-3 w-full text-sm
                           focus:ring-2 focus:ring-navy-mid focus:outline-none transition-all resize-none"
              />
              <button
                type="submit"
      ...
      {lightboxIndex !== null && (
        <Lightbox
          ...
          onPrev={() =>
            setLightboxIndex((i) => (i! > 0 ? i! - 1 : familyPhotos.length - 1))
          }
          onNext={() =>
            setLightboxIndex((i) => (i! < familyPhotos.length - 1 ? i! + 1 : 0))
          }
        />
      )}
    </>
